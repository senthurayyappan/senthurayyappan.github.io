...
export function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="sidenav hidden md:block" aria-label="Sections">
        <Link
          href="/"
          className="sidenav-mark"
          aria-label="Senthur Ayyappan — home"
        >
          <Image
            src="/logo/640.png"
      ...
      <div className="md:hidden flex items-center justify-between px-4 py-3 border-b border-current/15">
        <Link href="/" className="block w-28 h-12 relative overflow-hidden">
          <Image
            src="/logo/400.png"
            alt="SA"
            fill
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 border border-current/30 rounded-md"
          >
            <svg
      ...
      {mobileOpen && (
        <>
          ...
          />
          <div className="fixed top-0 left-0 h-full w-72 z-40 md:hidden p-6 flex flex-col gap-6 bg-[var(--background)] shadow-[0_20px_25px_-5px_rgba(21,19,13,0.10),0_8px_10px_-6px_rgba(21,19,13,0.10)]">
            <Link
              href="/"
              onClick={() => setMobileOpen(false)}
              className="block w-32 h-14 relative overflow-hidden self-start"
            >
              <Image
                src="/logo/400.png"
                alt="SA"
